...
editor_tree = ET.parse('/Users/stevenbailey/UDI Development PG3/Nodeservers/udi-poly-baspi-6u6r-python-master-v3/profile/editor/editors.xml')
...
nls = {}
with open('/Users/stevenbailey/UDI Development PG3/Nodeservers/udi-poly-baspi-6u6r-python-master-v3/profile/nls/en_us.txt') as fp:
    for line in fp:
        line = line.rstrip()
        if line != "" and line[0] != '#':
            pair = line.split(" = ")
...
node_tree = ET.parse('/Users/stevenbailey/UDI Development PG3/Nodeservers/udi-poly-baspi-6u6r-python-master-v3/profile/nodedef/nodedefs.xml')
